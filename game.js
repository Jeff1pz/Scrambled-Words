document.addEventListener('DOMContentLoaded', () => {
    ...
    function showNotification(message, type) {
        ...
        setTimeout(() => {
            notification.classList.add("fade-out"); // Start fade-out animation
    ...
    function showGameOverMessage(score) {
        ...
        message.innerHTML = `
            <h2>Game Over!</h2>
            <p>Time's up! Your final score:</p>
            <div class="score">${score}</div>
            <div class="message-buttons">
                <button class="message-btn primary-btn" onclick="restartGame()">
                    <i class="fas fa-redo"></i> Play Again
                </button>
                <button class="message-btn secondary-btn" onclick="backToGame()">
